...
#endif
    LCD_PWM_CLR;
    printf ("Raspberry Pi MZTX06A LCD Running...\n") ;
    printf ("http://jwlcd-tp.taobao.com\n") ;
    
    LCD_Init();
    loadFrameBuffer_diff();//when in config.txt framebuffer_width=640   framebuffer_height=480
    //loadFrameBuffer_diff_320();//when in config.txt framebuffer_width=320      framebuffer_height=240
