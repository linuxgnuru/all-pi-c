...
void LCD_test(void) // draws colors?
{
	u16  temp,num;
	u8 n,i;
...
void lcd_display_number(unsigned int x, unsigned int y, unsigned long num, unsigned char num_len )
{
