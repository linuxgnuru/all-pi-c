...
//  { 1, 0, 1, 1, 1, 1, 1, 0 }, // 0
    ...
    { 1, 1, 1, 0, 1, 1, 1, 1 }, // A. 10 (A)
    { 1, 1, 1, 1, 0, 0, 1, 1 }, // B. 11 (8) b
    { 1, 1, 1, 1, 0, 0, 1, 1 }, // B. 11 (8) b
    { 1, 0, 1, 1, 0, 1, 0, 1 }, // C. 12 (C) c
    { 1, 0, 1, 1, 0, 1, 0, 1 }, // C. 12 (C) c
    { 0, 1, 1, 1, 1, 0, 1, 1 }, // D. 13 (0) d
    { 0, 1, 1, 1, 1, 0, 1, 1 }, // D. 13 (0) d
    { 1, 1, 1, 1, 0, 1, 0, 0 }, // E  14 (error)
    { 1, 1, 1, 1, 0, 1, 0, 0 }, // E  14 (error)
    { 1, 1, 1, 0, 1, 0, 1, 1 }, // #. 15 (#) not used
    { 1, 1, 1, 0, 1, 0, 1, 1 }, // #. 15 (#) not used
    { 0, 1, 0, 1, 0, 1, 0, 1 }  // *. 16 (*) not used
    { 0, 1, 0, 1, 0, 1, 0, 1 }  // *. 16 (*) not used
};
