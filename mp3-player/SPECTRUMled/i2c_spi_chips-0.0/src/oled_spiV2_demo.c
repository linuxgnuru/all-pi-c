/* 128 x 64 OLED via 4-wire SPI Version 2 (manual reset) DEMOnstration code
 * $Id: oled_spiV2_demo.c,v 1.2 2018/05/14 23:01:23 pi Exp $
 */
...
static char RCSDate[]     = "$Date: 2018/05/14 23:01:23 $";
static char RCSFile[]     = "$RCSfile: oled_spiV2_demo.c,v $";
static char RCSId[]       = "$Id: oled_spiV2_demo.c,v 1.2 2018/05/14 23:01:23 pi Exp $";
...
/* Change Log */
/*
 * $Log: oled_spiV2_demo.c,v $
 * Revision 1.2  2018/05/14 23:01:23  pi
 * Interim commit
 *
 * Revision 1.1  2018/05/08 14:38:58  pi
 * Initial revision
 *
 *
 *
