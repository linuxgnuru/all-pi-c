...
#    msg = re.sub(" +", " ", msg)
#    print(msg)
#    show_message(device, msg, fill="white", font=proportional(CP437_FONT), scroll_delay=0)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--rotate', type=int, default=2, choices=[0, 1, 2, 3], help='Rotate display 0=0deg, 1=90deg, 2=180deg, 3=270deg')
